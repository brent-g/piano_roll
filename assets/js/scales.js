...
var scales = [
	...
	{'name':'C# Minor', 'type' : 'minor', 'key' : 'C-sharp', 	'sound' : '_C#', 'keys' : ['C#','D#','E','F#','G#','A','B','C#'], 	'harmonic' : ['C#','D#','E','F#','G#','A','B#','C#'],	'melodic':[]},
	{'name':'D Minor', 	'type' : 'minor', 'key' : 'D', 			'sound' : '_D',  'keys' : ['D','E','F','G','A','Bb','C','D'],		'harmonic' : ['D','E','F','G','A','Bb','C#','D'],		'melodic':[]},
	{'name':'Eb Minor', 'type' : 'minor', 'key' : 'E-flat',		'sound' : '_Eb', 'keys' : ['Eb','F','Gb','Ab','Bb','Cb','Db','Eb'],	'harmonic' : ['Eb','F','Gb','Ab','Bb','Cb','D','Eb'],	'melodic':[]},
	...
	{'name':'F# Minor', 'type' : 'minor', 'key'	: 'F-sharp', 	'sound' : '_F#', 'keys' : ['F#','G#','A','B','C#','D','E','F#'],	'harmonic' : ['F#','G#','A','B','C#','D','E#','F#'],	'melodic':[]},	
	{'name':'G Minor', 	'type' : 'minor', 'key' : 'G', 			'sound' : '_G',  'keys' : ['G','A','Bb','C','D','Eb','F','G'],		'harmonic' : ['G','A','Bb','C','D','Eb','F#','G'],		'melodic':[]},
	{'name':'G# Minor', 'type' : 'minor', 'key'	: 'G-sharp', 	'sound' : '_G#', 'keys' : ['G#','A#','B','C#','D#','E','F#','G#'], 	'harmonic' : ['G#','A#','B','C#','D#','E','G','G#'],	'melodic':[]},
	{'name':'A Minor', 	'type' : 'minor', 'key' : 'A', 			'sound' : '_A',  'keys' : ['A','B','C','D','E','F','G','A'], 		'harmonic' : ['A','B','C','D','E','F','G#','A'],		'melodic':[]},
	{'name':'Bb Minor', 'type' : 'minor', 'key' : 'B-flat',		'sound' : '_Bb', 'keys' : ['Bb','C','Db','Eb','F','Gb','Ab','Bb'],	'harmonic' : ['Bb','C','Db','Eb','F','Gb','A','Bb'],	'melodic':[]},
